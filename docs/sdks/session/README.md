...
* [increaseTimeout](#increasetimeout) - Increase Timeout
...
```typescript
import { ComfyDeployCore } from "comfydeploy/core.js";
import { sessionIncreaseTimeout } from "comfydeploy/funcs/sessionIncreaseTimeout.js";
...
async function run() {
  const res = await sessionIncreaseTimeout(comfyDeploy, {
    machineId: "<id>",
    sessionId: "d1cbd355-89fb-45f4-9778-6137629fc60d",
    timeout: 465465,
    gpu: "<value>",
...
import {
  // Mutation hook for triggering the API call.
  useSessionIncreaseTimeoutMutation
} from "comfydeploy/react-query/sessionIncreaseTimeout.js";
```
