...
import { deploymentsCreate } from "comfydeploy/funcs/deploymentsCreate.js";
...
async function run() {
  const res = await deploymentsCreate(comfyDeploy, {
    workflowVersionId: "<id>",
    workflowId: "<id>",
    machineId: "<id>",
    environment: "<value>",
...
} from "comfydeploy/react-query/deploymentsCreate.js";
```
...
**Promise\<[components.DeploymentModel](../../models/components/deploymentmodel.md)\>**
