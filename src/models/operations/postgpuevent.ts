...
/** @internal */
export const WsGpuType$inboundSchema: z.ZodNativeEnum<typeof WsGpuType> = z
  .nativeEnum(WsGpuType);

/** @internal */
export const WsGpuType$outboundSchema: z.ZodNativeEnum<typeof WsGpuType> =
  WsGpuType$inboundSchema;
...
/** @internal */
export const GpuProvider$inboundSchema: z.ZodNativeEnum<typeof GpuProvider> = z
  .nativeEnum(GpuProvider);
