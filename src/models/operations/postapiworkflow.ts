...
export type PostApiWorkflowRequestBody = {
 ...
 * Retrieve the output
 */
export type PostApiWorkflowResponseBody = {
    workflowId: string;
    version: string;
};
...
/** @internal */
export const PostApiWorkflowRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type PostApiWorkflowRequestBody$Outbound = {
...
/** @internal */
export const PostApiWorkflowRequestBody$outboundSchema: z.ZodType<
    PostApiWorkflowRequestBody$Outbound,
    z.ZodTypeDef,
    PostApiWorkflowRequestBody
> = z
    .object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace PostApiWorkflowRequestBody$ {
    /** @deprecated use `PostApiWorkflowRequestBody$inboundSchema` instead. */
    export const inboundSchema = PostApiWorkflowRequestBody$inboundSchema;
    /** @deprecated use `PostApiWorkflowRequestBody$outboundSchema` instead. */
    export const outboundSchema = PostApiWorkflowRequestBody$outboundSchema;
    /** @deprecated use `PostApiWorkflowRequestBody$Outbound` instead. */
    export type Outbound = PostApiWorkflowRequestBody$Outbound;
}
