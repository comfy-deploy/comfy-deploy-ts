...
/** @internal */
export const GetRunRequest$inboundSchema: z.ZodType<GetRunRequest, z.ZodTypeDef, unknown> = z
    .object({
        run_id: z.string(),
    })
    .transform((v) => {
...
/** @internal */
export const GetRunWorkflowApi$inboundSchema: z.ZodType<GetRunWorkflowApi, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const GetRunGpu$inboundSchema: z.ZodNativeEnum<typeof GetRunGpu> = z.nativeEnum(GetRunGpu);

/** @internal */
export const GetRunGpu$outboundSchema: z.ZodNativeEnum<typeof GetRunGpu> = GetRunGpu$inboundSchema;
...
> = z
    .object({
        ...
        workflow_api: z.lazy(() => GetRunWorkflowApi$inboundSchema),
...
export type GetRunResponseBody$Outbound = {
    ...
    workflow_api: GetRunWorkflowApi$Outbound;
...
> = z
    .object({
        ...
        workflowApi: z.lazy(() => GetRunWorkflowApi$outboundSchema),
