...
/** @internal */
export const PostV1MachinesType$inboundSchema: z.ZodNativeEnum<
  typeof PostV1MachinesType
> = z.nativeEnum(PostV1MachinesType);

/** @internal */
export const PostV1MachinesType$outboundSchema: z.ZodNativeEnum<
  typeof PostV1MachinesType
...
/** @internal */
export const PostV1MachinesStatus$inboundSchema: z.ZodNativeEnum<
  typeof PostV1MachinesStatus
> = z.nativeEnum(PostV1MachinesStatus);

/** @internal */
export const PostV1MachinesStatus$outboundSchema: z.ZodNativeEnum<
  typeof PostV1MachinesStatus
...
/** @internal */
export const PostV1MachinesGpu$inboundSchema: z.ZodNativeEnum<
  typeof PostV1MachinesGpu
> = z.nativeEnum(PostV1MachinesGpu);

/** @internal */
export const PostV1MachinesGpu$outboundSchema: z.ZodNativeEnum<
  typeof PostV1MachinesGpu
