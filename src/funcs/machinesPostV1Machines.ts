 ...
 */
export async function machinesPostV1Machines(
    ...
    Result<
        ...
        | errors.PostV1MachinesResponseBody
        | SDKError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.PostV1MachinesRequestBody$outboundSchema.optional().parse(value$),
