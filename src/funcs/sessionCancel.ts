...
export function sessionCancel(
  ...
  Result<
    components.DeleteSessionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteSessionSessionSessionIdDeleteRequest$outboundSchema
        .parse(value),
  ...
  const query = encodeFormQuery({
    "wait_for_shutdown": payload.wait_for_shutdown,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.DeleteSessionResponse$inboundSchema),
