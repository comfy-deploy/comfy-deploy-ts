 ...
 * Snapshot Session
 */
export function sessionSnapshotSessionSessionSessionIdSnapshotPost(
...
> {
  ...
  const body = encodeJSON("body", payload.SnapshotSessionBody, {
    explode: true,
  });
  ...
  const path = pathToFunc("/session/{session_id}/snapshot")(pathParams);
