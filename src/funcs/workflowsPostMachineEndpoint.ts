 ...
 */
export async function workflowsPostMachineEndpoint(
  ...
  Result<
    ...
    | errors.PostMachineEndpointResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PostMachineEndpointRequestBody$outboundSchema.optional().parse(
        value,
      ),
