 ...
 */
export function deploymentsGetFeaturedDeploymentsDeploymentsFeaturedGet(
...
> {
  const path = pathToFunc("/deployments/featured")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.DeploymentFeaturedModel$inboundSchema)),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
  if (!result.ok) {
