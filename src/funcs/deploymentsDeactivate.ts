 ...
 */
export function deploymentsDeactivate(
...
> {
  ...
  const path = pathToFunc("/deployment/{deployment_id}/deactivate")(pathParams);
  ...
  const context = {
    ...
    operationID:
      "deactivate_deployment_deployment__deployment_id__deactivate_post",
    oAuth2Scopes: [],
