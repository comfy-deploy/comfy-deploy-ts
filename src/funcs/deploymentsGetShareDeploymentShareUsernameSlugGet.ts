 ...
 */
export function deploymentsGetShareDeploymentShareUsernameSlugGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetShareDeploymentShareUsernameSlugGetRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/share/{username}/{slug}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.DeploymentShareModel$inboundSchema),
