 ...
 */
export async function deploymentGetInputDefinition(
  ...
  Result<
    ...
    | errors.GetDeploymentIdInputsResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetDeploymentIdInputsRequest$outboundSchema.parse(value),
