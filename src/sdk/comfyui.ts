...
export class Comfyui extends ClientSDK {
  ...
  async getAuthResponseRequestId(
    ...
    return unwrapAsync(comfyuiGetAuthResponseRequestId(
      this,
      request,
      options,
    ));
  ...
  async postWorkflow(
    ...
    return unwrapAsync(comfyuiPostWorkflow(
      this,
      request,
      options,
    ));
  ...
  async getWorkflowVersionVersionId(
    ...
    return unwrapAsync(comfyuiGetWorkflowVersionVersionId(
      this,
      request,
      options,
    ));
  ...
  async getWorkflowId(
    ...
    return unwrapAsync(comfyuiGetWorkflowId(
      this,
      request,
      options,
    ));
